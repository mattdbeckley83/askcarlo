...
const TokenBalance = () => {
    ...
    return (
        <div ref={containerRef} className="relative">
            ...
            >
                <PiCoins
                    className={`text-amber-400 transition-[filter] duration-300 ${isAnimating === 'spend' ? 'drop-shadow-[0_0_6px_rgba(245,158,11,0.85)]' : ''} ${isAnimating === 'grant' ? 'drop-shadow-[0_0_8px_rgba(34,197,94,0.9)]' : ''}`}
                    size={18}
                />
