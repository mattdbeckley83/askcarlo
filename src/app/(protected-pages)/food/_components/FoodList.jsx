...
const FoodList = ({ items = [], categories = [], foodTypeId }) => {
        ...
        <>
            <Card>
                <div className="flex items-center gap-4 mb-4">
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 whitespace-nowrap">Food Pantry</h1>
                                ...
                                <Tr>
                                    <Td colSpan={4} className="text-center py-8">
                                        <div className="flex flex-col items-center gap-2 text-gray-500">
                                            {items.length === 0 ? (
                                                <>
                                                    <p className="text-lg font-medium">No food yet</p>
