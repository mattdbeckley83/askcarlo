...
const EditGearModal = ({ isOpen, onClose, item, categories = [], gearTypeId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!gearTypeId) {
            setError('Gear type not configured')
            return
        }
        ...
        formData.set('item_type_id', gearTypeId)
        ...
        return (
            <Dialog isOpen={isOpen} onClose={handleClose} width={400} closable={false}>
                <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <div>
                        <h4 className="text-lg font-semibold mb-2">Delete Gear</h4>
    ...
    return (
        <Dialog isOpen={isOpen} onClose={handleClose} width={520} closable={false}>
            <div className="flex justify-between items-start mb-3">
                <h4 className="text-lg font-semibold">Edit Gear</h4>
                <button
                    type="button"
