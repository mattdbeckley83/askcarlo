...
const securityHeaders = [
    ...
    },
    {
        ...
        value: [
            ...
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://*.clerk.accounts.dev https://clerk.askcarlo.ai https://challenges.cloudflare.com https://vercel.live",
